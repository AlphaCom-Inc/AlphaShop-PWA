...
class Order extends AppModel {
    ...
    public static function mailOrder($order_id, $user_email){
        ...
        $transport = (new Swift_SmtpTransport(App::$app->getParams('smtp_host'), App::$app->getParams('smtp_port'), App::$app->getParams('smtp_protocol')))
            ->setUsername(App::$app->getParams('smtp_login'))
            ->setPassword(App::$app->getParams('smtp_password'))
        ;
        ...
        $message_client = (new Swift_Message("Вы совершили заказ №{$order_id} на сайте " . App::$app->getParams('shop_name')))
