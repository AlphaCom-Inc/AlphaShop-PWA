                    ...
                    <div class="product-item">
                        <div class="single-product p-0">
                            <div class="product-img">
                                ...
                                <span class="sticker-2">Изменить</span>
                            </div>
                            <div class="product-content p-4">
                                <div class="product-desc_info">
                                    <h4 class="product-name text-bold"><a href="single-product.html"><?=$_SESSION['user']['name'];?></a></h4>
                                    <p class="product-name"><a href="single-product.html"><?=$_SESSION['user']['email'];?></a></p>
                                </div>
                            </div>
                        </div>
                    </div>
